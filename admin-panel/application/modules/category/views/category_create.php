  ...
  <div class="col-md-12">
    ...
    <div class="panel panel-primary" data-collapsed="0">
      ...
      <div class="panel-body">
        ...
        <form role="form" class="form-horizontal form-groups-bordered validate" method="post" action="<?php echo base_url(); ?>category/save" name="createPage">
          <input type="hidden" name="id" value="<?php if(isset($list['id'])){echo $list['id'];} else {echo '';}?>">
          <div class="form-group">
            <label for="field-1" class="col-sm-3 control-label">Title</label>
            
            <div class="col-sm-5">
              <input type="text" class="form-control" data-validate="required" data-message-required="Title is required" name="cat_title" id="title" value="<?php if(isset($list['cat_title'])){echo $list['cat_title'];} else {echo '';}?>">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-5">
              <input type="text" class="form-control" data-validate="required" name="cat_alias" id="alias" value="<?php if(isset($list['cat_alias'])){echo $list['cat_alias'];} else {echo '';}?>">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-5">
              <select name="sec_id" class="form-control" data-validate="required">
                  <option value="">Select section</option>
                <?php foreach($sectionlist as $s): ?>
                  <option value="<?php echo $s->id; ?>" <?php if(isset($list['sec_id'])){ if($s->id == $list['sec_id']){echo "selected";}} ?>><?php echo $s->sec_title; ?></option>
                <?php endforeach; ?>
              </select>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <textarea class="form-control autogrow" name="cat_desc" id="content" placeholder=""><?php if(isset($list['cat_desc'])){echo $list['cat_desc'];} else {echo '';}?></textarea>
