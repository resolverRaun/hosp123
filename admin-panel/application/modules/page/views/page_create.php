  ...
  <div class="col-md-12">
    ...
    <div class="panel panel-primary" data-collapsed="0">
      ...
      <div class="panel-body">
        ...
        <form role="form" class="form-horizontal form-groups-bordered validate" method="post" action="<?php echo base_url(); ?>page/save" name="createPage">
          <input type="hidden" name="id" value="<?php if(isset($list['id'])){echo $list['id'];} else {echo '';}?>">
          <div class="form-group">
            <label for="field-1" class="col-sm-3 control-label">Title</label>
            
            <div class="col-sm-5">
              <input type="text" class="form-control" data-validate="required" data-message-required="Title is required" name="page_title" id="title" value="<?php if(isset($list['page_title'])){echo $list['page_title'];} else {echo '';}?>">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-5">
              <input type="text" class="form-control" data-validate="required" name="page_alias" id="alias" value="<?php if(isset($list['page_alias'])){echo $list['page_alias'];} else {echo '';}?>">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <label for="field-6" class="col-sm-3 control-label">Feature</label>
            <div class="col-sm-5">
              <div class="radio">
                <label>
                  <input type="radio" name="feature" id="optionsRadios1" value="1" <?php if(isset($list['feature'])){ if($list['feature']==1) {echo "checked";}}else{echo "checked";} ?>>Yes
                </label>
              </div>
              <div class="radio">
                <label>
                  <input type="radio" name="feature" id="optionsRadios2" value="0" <?php if(isset($list['feature'])){ if($list['feature']==0) echo "checked";} ?>>No
                </label>
              </div>
            </div>
          </div>
          ...
          <div class="form-group">
            <label for="field-3" class="col-sm-3 control-label">Section</label>
            <div class="col-sm-5">
              <select name="cat_id" class="form-control">
                  <option value="">Select Category</option>
                <?php foreach($dropdownlist as $s): ?>
                  <option value="<?php echo $s->id; ?>" <?php if(isset($list['cat_id'])){ if($s->id == $list['cat_id']){echo "selected";}} ?>><?php echo $s->cat_title; ?></option>
                <?php endforeach; ?>
              </select>
            </div>
          </div>
          ...
          <div class="form-group">
            <label for="field-ta_fd" class="col-sm-3 control-label">Short Description</label>
            
            <div class="col-sm-8">
              <textarea class="form-control autogrow" name="short_desc" id="content_2" placeholder=""><?php if(isset($list['short_desc'])){echo $list['short_desc'];} else {echo '';}?></textarea>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <textarea class="form-control autogrow" name="long_desc" id="content" placeholder=""><?php if(isset($list['long_desc'])){echo $list['long_desc'];} else {echo '';}?></textarea>
