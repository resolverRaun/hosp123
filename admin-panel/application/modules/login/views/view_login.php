    ...
    <div class="login-form">
        ...
        <div class="login-content">
          ...
          <?php endif; ?>
            ...
            <form method="post" role="form" class="validate" action="<?php echo base_url(); ?>login/verifyLogin">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="useremail" id="useremail" data-validate="required" data-message-required="Useremail Required" placeholder="Mail" autocomplete="off" />
                    </div>
            ...
            <div class="login-bottom-links">
                ...
                <a href="<?php base_url(); ?>signup" class="link">Sign Up</a>

                </br>
                <a href="<?php base_url(); ?>login/forgetPassword/" class="link">Forgot your password?</a>
