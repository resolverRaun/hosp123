<form role="form" method="post" action="<?php echo base_url();?>section/handler">
  ...
  <tbody>
    <? foreach($list as $r):?>
        <tr class="test">
          ...
          <td><a href='<?php echo base_url()?>section/edit/<?php echo $r->id ?>' class="btn btn-default btn-sm btn-icon icon-left">
