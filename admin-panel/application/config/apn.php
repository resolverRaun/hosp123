...
|
*/
$config['PermissionFile'] = 'files/certificates/Golfck.pem';
...
|--------------------------------------------------------------------------
*/
// $config['Sandbox'] = true; /* For Development Purpose */
...
// $config['FeedbackGatewaySandbox'] = 'ssl://feedback.push.apple.com:2196';
